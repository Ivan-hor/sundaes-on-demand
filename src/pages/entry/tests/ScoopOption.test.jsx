...
test('invalid if scoop count is non-int or out of range', async () => {
  render(<ScoopOptions name="" imagePath="" updateItemCount={jest.fn()} />);
  // to make happy typescript = use this name="" imagePath=""
  //  console.error Error: Uncaught [TypeError: updateItemCount is not a function]
  //to mock function use this updateItemCount={jest.fn()}
